        ...
        return ReloadableServerRegistries.reload(pRegistries, pResourceManager, pBackgroundExecutor)
            .thenCompose(
                p_326196_ -> {
                    ...
                    listeners.addAll(net.minecraftforge.event.ForgeEventFactory.onResourceReload(reloadableserverresources, reloadableserverresources.registryLookup, pRegistries.compositeAccess()));
